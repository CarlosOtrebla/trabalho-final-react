...
const team = [
  {
    name: "Geisila",
    bio: "Tenho 41 anos, mãe de 3 filhos; me considero muito resiliente, dedicada, pontual, organizada e alegre e procuro sempre ver o lado positivo da vida! ",
    photo: "/src/assets/img/ge.png",
  },
  {
    name: "Carlos",
    bio: "Sou um homem casado com uma esposa maravilhosa, Mariana,  pai de dois meninos, João e Sebastião que são a razão da minha constante luta para alcançar meus objetivos. Tenho 47 anos, e sou apaixonado por música Sertaneja, “de 2000 pra trás”, salvo algumas exceções atuais, bem poucas. kkkk. Sou extrovertido, brincalhão e adoro fazer novas amizades.",
    photo: "/src/assets/img/Carlos.webp",
  },
  {
    name: "Patrick",
  ...
  {
    name: "Marcela",
    bio: "Tenho 55 anos, mãe de três filhos. Sou corredora amadora, extrovertida, dedicada e agregadora. Amo desafios.",
    photo: "/src/assets/img/marcela.jpg",
  },
];
